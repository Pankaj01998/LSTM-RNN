...
#selecting file with min loss
filename = "weights-improvement-20-2.0388.hdf5"

model.load_weights(filename)
model.compile(loss = 'categorical_crossentropy', optimizer='adam')

#for converting numbers to char
int_to_char = dict((i,c) for i, c in enumerate(chars))

print int_to_char

#pick a random sequence of characters 
...
#predict next 1000 characters for random input
for i in range(1000):
